               ...
               for (
                  this._lazy !== !1 && (this._lazy = !1),
                     ...
                     0 === r &&
                        ...
                        this._startAt &&
                           (a >= 0 ? this._startAt.render(a, b, d) : f || (f = '_dummyGS')),
                        this.vars.onStart &&
            ...
            (k.time = function (a, b) {
               return arguments.length
                  ? (this._dirty && this.totalDuration(),
                    ...
                    this._yoyo && 0 !== (1 & this._cycle)
                       ? (a =
                            this._duration - a + this._cycle * (this._duration + this._repeatDelay))
                       : 0 !== this._repeat &&
         ...
         function (a, b, c) {
            ...
            return (
               ...
               (q._parseTimeOrLabel = function (b, c, d, e) {
                  ...
                  if (
                     ((c = c || 0), 'string' != typeof b || (!isNaN(b) && null == this._labels[b]))
                  )
                     null == b && (b = f)
                  else {
                     if (((g = b.indexOf('=')), -1 === g))
               ...
               (q.render = function (a, b, c) {
                  ...
                  if ((this._time !== o && this._first) || c || i || l) {
                     if (
                        ...
                        this._active ||
                           (!this._paused && this._time !== o && a > 0 && (this._active = !0)),
                        0 === o &&
                           this.vars.onStart &&
            ...
            p = _gsScope._gsDefine.plugin({
               ...
               set: function (b) {
                  ...
                  if (this._timeRes) {
                     ...
                     if (
                        ((c = e), (b -= this._l1), (e = this._si), b > this._s2 && e < l.length - 1)
                     ) {
            ...
            var k,
               ...
               ha = function (a, b) {
                  ...
                  var c,
                     d = a.split(' '),
                     e =
                        -1 !== a.indexOf('left') ? '0%' : -1 !== a.indexOf('right') ? '100%' : d[0],
            ...
            var b,
               ...
               m = function (a, b, c) {
                  ;(this.t = a),
                     (this.v = b),
                     c &&
                        ((this.next = c), (c.prev = this), (this.c = c.v - b), (this.gap = c.t - a))
               },
               n = function (b, c) {
                  var d = i(
                        'easing.' + b,
            ...
            return (
               ...
               l(
                  ...
                  d(
                     ...
                     function (a) {
                        return (
                           this._p1 * Math.pow(2, -10 * a) * Math.sin((a - this._p3) * this._p2) + 1
                        )
                     },
                     0.3
                  ),
      ...
      if (!e.TweenLite) {
         ...
         E(),
            ...
            (h.reverse = function (a, b) {
               return (
                  null != a && this.seek(a || this.totalDuration(), b), this.reversed(!0).paused(!1)
               )
            }),
            ...
            O = function (a, b, c, d) {
               ...
               for (
                  ...
                  (k = f[h]),
                     ...
                     (m += k.length)
               return (
                  (n += b.substr(m)), n && l.push(n), (l.setRatio = N), M.test(b) && (l.end = 0), l
               )
            },
